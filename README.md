...
## WARNING
This branch is way less tested than the regular [bleeding-arm branch](https://github.com/armdevvel/mxe-SHARED/tree/bleeding-arm). It's intended to update things way more by request of other developers, and simply time bringing us to need a newer version of LLVM, but will be much slower progress as LLVM 14 is the main compiler we use still.
...
## Building (configuring) with each build system
  ...
  * Autoconf:
    - Use `./configure --host=armv7-w64-mingw32 --prefix=/home/youruser/armmxe-shared/usr/armv7-w64-mingw32`
  * Meson:
