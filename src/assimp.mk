...
define $(PKG)_BUILD
    cd '$(BUILD_DIR)' && $(TARGET)-cmake \
        ...
        -DCMAKE_C_FLAGS='-Wno-error=array-bounds -Wno-error=unused-but-set-variable -Wno-error=uninitialized' \
        -DCMAKE_CXX_FLAGS='-Wno-error=array-bounds -Wno-error=unused-but-set-variable -Wno-error=uninitialized' \
        '$(SOURCE_DIR)'
